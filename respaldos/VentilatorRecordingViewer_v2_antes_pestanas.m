classdef VentilatorRecordingViewer < matlab.apps.AppBase
            ...
            try
                switch app.CurrentFileType
                    ...
                    case 'recruitments'
                        ...
                        % Visualize recruitment in the axes
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.AxesPressure.Position = [20 550 550 180];
            ...
            app.AxesFlow.Position = [20 330 550 180];
            ...
            app.AxesVolume.Position = [20 110 550 180];
            ...
            % Create Axes for configurable Loop (right side)
            app.AxesLoop = uiaxes(app.RightPanel);
            app.AxesLoop.Position = [600 110 530 620];
            title(app.AxesLoop, 'Loop Configurable');
            xlabel(app.AxesLoop, 'Presión (cmH2O)');
            ylabel(app.AxesLoop, 'Volumen (mL)');
